...
WebUI.setText(findTestObject('Object Repository/Bugiffy_Objects/Page_React After Login/Page_React App/input_Email Id_form-control'), 
    'shijiny.basheer@xilligence.com')
...
//WebUI.verifyElementText(findTestObject('Object Repository/Bugiffy_Objects/Page_React After Login/Page_React App/li_ANAnjanaNair'), 
//    'AN Anjana Nair')
WebUI.verifyTextPresent('SB Shijiny Basheer', true)
