...
WebUI.verifyElementText(findTestObject('Object Repository/Bugiffy_Objects/Page_React After Login/Page_React App/div_Kindly enter an email-Id'), 
    'Kindly enter an email-Id')
