...
WebUI.callTestCase(findTestCase('Learning/Login'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'This is testing using katalon studio')
